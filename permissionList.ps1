...
try {
    ...
    if ( $($ex.Exception.GetType().FullName -eq 'Microsoft.PowerShell.Commands.HttpResponseException') -or $($ex.Exception.GetType().FullName -eq 'System.Net.WebException')) {
        ...
        $errorMessage = "Could not receive Salesforce entitlements. Error: $($errorObj.ErrorMessage)"
    } else {
        $errorMessage = "Could not receive Salesforce entitlements. Error: $($ex.Exception.Message)"
    }
